...
export default function Portfolio() {
  return (
    ...
    <main className="overflow-hidden bg-slate-900 pb-4 lg:-mt-2">
      <div className="relative mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative lg:grid lg:grid-cols-3 lg:gap-x-8">
          <div className="lg:col-span-1">
            <h2 className="text-3xl font-bold tracking-tight text-slate-50 sm:text-4xl">More Than Just A <span className='text-sky-500'>Freelancer</span></h2>
          ...
          <dl className="mt-10 space-y-10 sm:grid sm:grid-cols-2 sm:gap-x-8 sm:gap-y-10 sm:space-y-0 lg:col-span-2 lg:mt-0">
            <div>
              <dt>
                ...
                <p className="mt-5 text-lg font-medium leading-6 text-slate-50">Communication</p>
              </dt>
            ...
            <div>
              <dt>
                ...
                <p className="mt-5 text-lg font-medium leading-6 text-slate-50">Transparency</p>
              </dt>
              <dd className="mt-2 text-base text-gray-500">
            ...
            <div>
              <dt>
                ...
                <p className="mt-5 text-lg font-medium leading-6 text-slate-50">Collaboration</p>
              </dt>
              <dd className="mt-2 text-base text-gray-500">
            ...
            <div>
              <dt>
                ...
                <p className="mt-5 text-lg font-medium leading-6 text-slate-50">Results Driven</p>
              </dt>
              <dd className="mt-2 text-base text-gray-500">
