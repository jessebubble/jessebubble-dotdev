...
export default function BlogPost() {
    ...
    return (    
                            ...
                            <div className="relative px-8">
                                <blockquote className="mt-8">
                                    ...
                                    <footer className="mt-4">
                                        <p className="text-base font-semibold text-indigo-200">blog | Inside The Bubble</p>
        ...
        <main className="overflow-hidden bg-slate-900 pb-4">
            <div className="relative mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:px-8">
                ...
                <defs>
                    ...
                    <rect x="0" y="0" width="4" height="4" className="text-yellow-300" fill="currentColor" />
                    </pattern>
                </defs>
                ...
                <div className="lg:col-span-1">
                    <h2 className="text-3xl font-bold tracking-tight text-white sm:text-4xl">More Than Just A <span className='text-yellow-400'>Freelancer</span></h2>
                ...
                <dl className="mt-10 space-y-10 sm:grid sm:grid-cols-2 sm:gap-x-8 sm:gap-y-10 sm:space-y-0 lg:col-span-2 lg:mt-0">
                    <div>
                    <dt>
                        <div className="flex h-12 w-12 items-center justify-center rounded-md bg-yellow-400 text-white">
                        ...
                        <p className="mt-5 text-lg font-medium leading-6 text-white">Communication</p>
                    </dt>
                    ...
                    <dt>
                        ...
                        <p className="mt-5 text-lg font-medium leading-6 text-white">Transparency</p>
                    </dt>
                    <dd className="mt-2 text-base text-gray-500">
                    ...
                    <dt>
                        ...
                        <p className="mt-5 text-lg font-medium leading-6 text-white">Collaboration</p>
                    </dt>
                    <dd className="mt-2 text-base text-gray-500">
                    ...
                    <dt>
                        ...
                        <p className="mt-5 text-lg font-medium leading-6 text-white">Results Driven</p>
                    </dt>
                    <dd className="mt-2 text-base text-gray-500">
