export const heroArray = [
    {
        ...
        role: 'Web Developer',
        imageUrl: 'https://cdn.sanity.io/images/etrj839y/production/70b8c26e3576f568fb3c994b07e08fde0b3c9927-1495x1125.png',
        bio: "Hey, I'm Jesse. I'm a San Antonio native with strong interpersonal and communication skills. Currently working as a cloud engineer through _nology. ",
        twitterUrl: 'https://twitter.com/jessebubble',
        linkedinUrl: 'https://www.linkedin.com/in/jessebubble/',
        githubUrl: 'https://github.com/jessebubble',
    },
]
...
export const portfolioArray = [
    {
        ...
        bio: 'Client needed an online prescence to offically launch their brand in San Antonio. Built with React, TailwindCSS and Sanity as the headless CMS. With sanity, we were able to build a fast, SEO-friendly website our client can easily update in the future.',
    ...
    },
    {
        ...
        webUrl: 'https://www.vivawreaths.com/',
    },
  ]